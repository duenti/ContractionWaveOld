...
public class ShowAnnoMarkerColorThickDialog {
	...
	public static void showDialog(PackageData mainpack, IntervalMarker current_marker, XYPlot plot, List<Integer> valid_maximum_list, List<Integer> valid_minimum_list,List<Integer> first_points, List<Integer> fifth_points, int zoomMinValue) {
...
//	    GridPane.setValignment(buttonTypeOk, VPos.CENTER);
	    ...
	    buttonTypeOk.setOnAction(new EventHandler<ActionEvent>() {
	    	...
	    	public void handle(ActionEvent event) {
	        	...
	        	ShowAnnoMarkerColorThickDialog.redrawAnnotations(mainpack, plot, valid_maximum_list, valid_minimum_list, first_points, fifth_points, zoomMinValue);
